...
const DIAGNOSTICS = [
  {
    id: "toxic-input",
    fungiFile: "packages-ts/galerina-devtools-benchmarks/benchmarks/toxic-input/benchmark.fungi",
    scenarios: {
  ...
  },
  {
    ...
    fungiFile: "packages-ts/galerina-devtools-benchmarks/benchmarks/governance-violation/benchmark.fungi",
    scenarios: {
  ...
  },
  {
    ...
    fungiFile: "packages-ts/galerina-devtools-benchmarks/benchmarks/resource-exhaustion/benchmark.fungi",
    scenarios: {
  ...
  },
  {
    ...
    fungiFile: "packages-ts/galerina-devtools-benchmarks/benchmarks/logging-throughput/benchmark.fungi",
    scenarios: {
