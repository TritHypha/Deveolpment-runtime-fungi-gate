...
- Added `packages-ts/galerina-framework-api-server/` positioning across Galerina core docs as the built-in HTTP API server that delegates to the Secure App Kernel.
