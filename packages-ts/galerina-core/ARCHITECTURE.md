...
```text
Tri / Galerina / Omni      -> packages-ts/galerina-core-logic
vector values and lanes    -> packages-ts/galerina-core-vector
compute target selection   -> packages-ts/galerina-core-compute
AI inference contracts     -> packages-ts/galerina-ai
Low-bit AI backend         -> packages-ts/galerina-ai-lowbit
photonic concepts          -> packages-ts/galerina-core-photonic
CPU target planning        -> packages-ts/galerina-target-cpu
CPU kernel contracts       -> packages-ts/galerina-cpu-kernels
binary target backend      -> packages-ts/galerina-target-native
photonic target backend    -> packages-ts/galerina-target-photonic
developer commands         -> packages-ts/galerina-core-cli
safe automation tasks      -> packages-ts/galerina-core-tasks
```
...
```text
packages-ts/ = Galerina ecosystem packages
