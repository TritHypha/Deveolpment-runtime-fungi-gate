...
logic reports belong in `packages-ts/galerina-core-logic/`.

Current v0.2 package contract: use `packages-ts/galerina-core-logic/README.md`
and `../../../../ZTF-Knowledge-Bases/reference/galerina/galerina-core-logic-tri-decision-bool.md` as canonical
