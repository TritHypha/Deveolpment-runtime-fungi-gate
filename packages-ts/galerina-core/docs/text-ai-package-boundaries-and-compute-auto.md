...
Low-bit AI support belongs in `packages-ts/galerina-ai-lowbit/`, with generic AI
contracts in `packages-ts/galerina-ai/`. BitNet can be selected as a backend there, but
