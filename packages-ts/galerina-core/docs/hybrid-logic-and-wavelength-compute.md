...
Ownership note: logic semantics belong in `packages-ts/galerina-core-logic/`, vector concepts
belong in `packages-ts/galerina-core-vector/`, compute planning belongs in
`packages-ts/galerina-core-compute/`, photonic vocabulary belongs in `packages-ts/galerina-core-photonic/`
and photonic backend target planning belongs in `packages-ts/galerina-target-photonic/`.
