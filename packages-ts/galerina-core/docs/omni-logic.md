...
belong in `packages-ts/galerina-core-logic/`.

Current v0.2 package contract: Omni states are documented in
`packages-ts/galerina-core-logic/README.md` and
`../../../../ZTF-Knowledge-Bases/reference/galerina/galerina-core-logic-omni-logic.md`. Uncertain Omni states
