...
details belong in `packages-ts/galerina-core-runtime/`. API workload controls, queue handoff,
rate limits and request cancellation policy belong in `packages-ts/galerina-framework-app-kernel/`.
