...
`compute auto`, but vector semantics belong in `packages-ts/galerina-core-vector/` and compute
planning semantics belong in `packages-ts/galerina-core-compute/`.
