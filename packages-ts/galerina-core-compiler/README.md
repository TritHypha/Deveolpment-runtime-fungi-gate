...
```text
packages-ts/galerina-core-compiler/src/manifests/
```
...
See `../../../ZTF-Knowledge-Bases/reference/language/effect-checker-and-boundary-checker.md` for the full
...
`../../../ZTF-Knowledge-Bases/reference/language/effect-checker-and-boundary-checker.md` for the
