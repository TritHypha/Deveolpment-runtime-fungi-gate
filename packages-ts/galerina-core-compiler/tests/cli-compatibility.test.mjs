...
const BENCH  = join(ROOT, "packages-ts/galerina-devtools-benchmarks/benchmarks/governance-cost/benchmark.fungi");
...
describe("CLI compatibility — galerina deploy", () => {
  ...
  const BENCH_REL = "packages-ts/galerina-devtools-benchmarks/benchmarks/governance-cost/benchmark.fungi";
