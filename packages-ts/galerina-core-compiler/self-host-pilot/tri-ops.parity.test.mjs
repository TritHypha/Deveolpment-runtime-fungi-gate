...
//   packages-ts/galerina-core-logic/src/index.ts  (built dist)
...
//
// Run:  node --test packages-ts/galerina-core-compiler/self-host-pilot/tri-ops.parity.test.mjs
// =============================================================================
...
// Repo root is four levels up: self-host-pilot -> galerina-core-compiler -> packages-ts -> <root>
...
// ---------------------------------------------------------------------------
const ts = require(
  resolve(REPO_ROOT, "packages-ts", "galerina-core-logic", "dist", "index.js"),
);
