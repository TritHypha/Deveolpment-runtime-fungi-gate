...
- `packages-ts/galerina-framework-app-kernel` — the kernel that folds these factors
- `packages-ts/galerina-core-network` — the shipped `certGate` (TLSTP S1)
- `packages-ts/galerina-tower-citizen` — the K3 verdict algebra
- `../../../ZTF-Knowledge-Bases/reference/galerina/galerina-tlstp-s1-cert-gate.md` — the cert-gate spec
