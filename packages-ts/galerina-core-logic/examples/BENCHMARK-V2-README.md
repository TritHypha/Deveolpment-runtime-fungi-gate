...
```powershell
node packages-ts\galerina-core\compiler\galerina.js run packages-ts\galerina-core\examples\compute-mix-throughput-benchmark.fungi --target-ms 20000 --warmup-ms 2000 --batch-size 100000 --buffer-size 65536
```

Direct Node.js:

```powershell
node packages-ts\galerina-core\examples\compute-mix-throughput-benchmark.node.js --target-ms 20000 --warmup-ms 2000 --batch-size 100000 --buffer-size 65536
```

Python:

```powershell
python packages-ts\galerina-core\examples\compute-mix-throughput-benchmark.py --target-ms 20000 --warmup-ms 2000 --batch-size 100000 --buffer-size 65536 --no-tracemalloc
```
