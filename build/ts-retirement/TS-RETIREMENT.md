# Executable-family retirement graph (1427 tracked package paths; 519 .ts-family)
...
Complete executable family: 504 .ts source · 15 .d.ts · 0 .mts · 0 .cts · 896 .mjs · 12 .js · 0 .cjs.

Terminal physical retirement: OPEN — 1427 tracked package executable-family paths remain.

Post-SLIDE authority: OPEN — 2 non-authorizing candidate(s); 0/118 production Fungi sources cryptographically admitted; 0/45 host boundaries owned; 95 node_modules trees.

`.fungi` in src trees: 118 across 95 packages · staged-index drift: 0
