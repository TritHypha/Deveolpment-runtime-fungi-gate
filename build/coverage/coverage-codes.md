...
Index: code-index.json (996 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (87 FUNGI codes).

## Universal coverage (anchor std #1)
- 996/996 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- governance-rules.md CURATION gap: 545 src-real FUNGI-* lack a semantic entry in the curated registry (they ARE in the derived registry). Generate/curate per std #10.
- PHANTOM doc-only drift: 112 (std #9/#10 → DOC-004).
- INLINE / no exported constant (R4): 384 (std #5 → taxonomy Stage F).
...
## Coverage holes: 0 · curation backlog: 545 · drift: 112 · R4-inline: 384 · RESERVED: 13
