...
Index: code-index.json (777 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (79 FUNGI codes).

## Universal coverage (anchor std #1)
- 777/777 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
## Coverage holes: 0 · curation backlog: 453 · drift: 113 · R4-inline: 175 · RESERVED: 13
