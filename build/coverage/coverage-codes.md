...
Index: code-index.json (995 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (87 FUNGI codes).

## Universal coverage (anchor std #1)
- 995/995 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- governance-rules.md CURATION gap: 544 src-real FUNGI-* lack a semantic entry in the curated registry (they ARE in the derived registry). Generate/curate per std #10.
...
## Coverage holes: 0 · curation backlog: 544 · drift: 112 · R4-inline: 383 · RESERVED: 13
