...
Index: code-index.json (734 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (76 FUNGI codes).

## Universal coverage (anchor std #1)
- 734/734 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
## Coverage holes: 0 · curation backlog: 444 · drift: 113 · R4-inline: 169 · RESERVED: 13
