...
Index: code-index.json (973 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (79 FUNGI codes).

## Universal coverage (anchor std #1)
- 973/973 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- INLINE / no exported constant (R4): 362 (std #5 → taxonomy Stage F).
...
## Coverage holes: 0 · curation backlog: 534 · drift: 113 · R4-inline: 362 · RESERVED: 13
