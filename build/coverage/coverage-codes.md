...
Index: code-index.json (974 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (79 FUNGI codes).

## Universal coverage (anchor std #1)
- 974/974 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
## Coverage holes: 0 · curation backlog: 534 · drift: 113 · R4-inline: 364 · RESERVED: 13
