...
Index: code-index.json (781 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (79 FUNGI codes).

## Universal coverage (anchor std #1)
- 781/781 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
...
- governance-rules.md CURATION gap: 455 src-real FUNGI-* lack a semantic entry in the curated registry (they ARE in the derived registry). Generate/curate per std #10.
...
## Coverage holes: 0 · curation backlog: 455 · drift: 113 · R4-inline: 177 · RESERVED: 13
