...
Index: code-index.json (768 codes) · Derived registry: build/code-registry (ALL codes, by construction) · Curated: galerina-governance-rules.md (79 FUNGI codes).

## Universal coverage (anchor std #1)
- 768/768 codes catalogued in the DERIVED registry by construction → NO ORPHANS ✓
