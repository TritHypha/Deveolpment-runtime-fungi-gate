...
> and green (`galerina-core-compiler` 5,748/5,748; whole suite 98/98 packages,
> 8,637 tests, zero failures). All seven canonical `.fungi` compiler stages
...
for the LIVE generated catalog — <!-- registry:counts.live -->147 live codes of <!-- registry:counts.total -->750 total
