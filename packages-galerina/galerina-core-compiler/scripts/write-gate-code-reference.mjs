...
const TIER_ORDER = ["PARSE", "REGISTRY", "RESOLVE", "WIRE", "TERM", "AUTH", "LIVE", "EFFECT", "SEM", "INTERNAL"];
const TIER_BLURB = {
  ...
  TERM: "Tier 3a — termination: part-to-part cycles are refused unless every edge in the cycle carries a bound.",
