...
| 5 | ⚪ | Galerina/WASM legacy lane | 0.00 bytes/op ⚡ ~0 — no boxing | 469.03M/s | — | 41KB |
...
| compute-mix | Galerina/WASM legacy lane | 93.9MB | 93.9MB | 18.3MB | 22KB |
...
| arithmetic-threshold | Galerina/WASM legacy lane | 101.5MB | 101.5MB | 18.9MB | 6KB |
...
| six-digit-guess | Galerina/WASM legacy lane | 102.3MB | 102.3MB | 19.1MB | 1KB |
...
| record-allocation | Galerina/WASM legacy lane | 103.2MB | 103.2MB | 19.7MB | 50KB |
...
| fibonacci-recursive | Galerina/WASM legacy lane | 104.1MB | 104.1MB | 19.8MB | 3KB |
...
| tower-of-hanoi | Galerina/WASM legacy lane | 104.3MB | 104.3MB | 19.0MB | 1KB |
...
| collection-pipeline | Galerina/WASM legacy lane | 106.6MB | 106.6MB | 19.0MB | 26KB |
...
| governance-cost | Galerina/WASM legacy lane | 106.1MB | 106.1MB | 19.1MB | 50KB |
...
| hardware-targets | Galerina/WASM legacy lane | 106.8MB | 106.8MB | 19.3MB | 74KB |
...
| low-memory | Galerina/WASM legacy lane | 107.1MB | 107.1MB | 19.3MB | 41KB |
...
| gpu-compute | Galerina/WASM legacy lane | 107.7MB | 107.7MB | 19.4MB | 2KB |
...
| matrix-multiply | Galerina/WASM legacy lane | 107.8MB | 107.8MB | 19.5MB | 3KB |
...
| tri-logic | Galerina/WASM legacy lane | 109.5MB | 109.5MB | 20.1MB | 1KB |
...
| call-chain | Galerina/WASM legacy lane | 110.0MB | 110.0MB | 20.3MB | 1KB |
...
| nbody | Galerina/WASM legacy lane | 111.7MB | 111.7MB | 22.8MB | 1KB |
...
| mandelbrot | Galerina/WASM legacy lane | 117.1MB | 117.1MB | 23.4MB | 1KB |
...
| binary-trees | Galerina/WASM legacy lane | 116.0MB | 116.0MB | 23.2MB | 2KB |
...
| compute-mix | Galerina/WASM legacy lane | 1.33s | 1.33s | 100% | 75.3K ops/CPU-ms |
...
| six-digit-guess | Galerina/WASM legacy lane | 1.15s | 1.16s | 100% | 36.4K ops/CPU-ms |
...
| record-allocation | Galerina/WASM legacy lane | 1.01s | 1.03s | 102% | 533.5K ops/CPU-ms |
...
| fibonacci-recursive | Galerina/WASM legacy lane | 1.05s | 1.03s | 99% | 17.46 ops/CPU-ms |
...
| tower-of-hanoi | Galerina/WASM legacy lane | 1.08s | 1.08s | 100% | 121.5K ops/CPU-ms |
...
| collection-pipeline | Galerina/WASM legacy lane | 1.01s | 1.02s | 101% | 413.4K ops/CPU-ms |
...
| hardware-targets | Galerina/WASM legacy lane | 1.00s | 1.00s | 100% | 36.3K ops/CPU-ms |
...
| low-memory | Galerina/WASM legacy lane | 1.00s | 1.00s | 100% | 470.0K ops/CPU-ms |
...
| gpu-compute | Galerina/WASM legacy lane | 1.07s | 1.08s | 101% | 463.8K ops/CPU-ms |
...
| matrix-multiply | Galerina/WASM legacy lane | 1.04s | 1.05s | 100% | 438.6K ops/CPU-ms |
...
| tri-logic | Galerina/WASM legacy lane | 1.28s | 1.28s | 100% | 468.0K ops/CPU-ms |
...
| call-chain | Galerina/WASM legacy lane | 1.85s | 1.84s | 100% | 54.2K ops/CPU-ms |
...
| nbody | Galerina/WASM legacy lane | 1.13s | 1.13s | 99% | 29.1K ops/CPU-ms |
...
| mandelbrot | Galerina/WASM legacy lane | 1.82s | 1.81s | 100% | 9.0K ops/CPU-ms |
...
| binary-trees | Galerina/WASM legacy lane | 1.16s | 1.16s | 99% | 587.6K ops/CPU-ms |
...
| 4 | ⚪ | Galerina/WASM legacy lane | 75.04M/s | 1.33s | 1.33s | 93.9MB | ~0 | 103.9× | 0.56× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (155 B/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 4 | ⚪ | Galerina/WASM legacy lane | 489.53M/s | 1.03s | 1.03s | 101.5MB | ~0 | 130.4× | 0.53× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (18.5 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 🥉 | 🟢 | Galerina/WASM legacy lane | 36.43M/s | 1.15s | 1.16s | 102.3MB | ~0 | 423.8× | 13.2× |
...
| 🥉 | 🟢 | Galerina/WASM legacy lane | 542.58M/s | 1.01s | 1.03s | 103.2MB | ~0 | 152.1× | 9.48× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (137 B/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 🥈 | 🟢 | Galerina/WASM legacy lane | 17.2K/s | 1.05s | 1.03s | 104.1MB | ~0 | 4.4K× | 135.3× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina manifest ⟨interp⟩ (1773.4 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 4 | 🟢 | Galerina/WASM legacy lane | 121.55M/s | 1.08s | 1.08s | 104.3MB | ~0 | 51.3× | 0.94× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (9.2 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 🥉 | 🟢 | Galerina/WASM legacy lane | 416.74M/s | 1.01s | 1.02s | 106.6MB | ~0 | 43.9× | 5.82× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (130 B/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| Galerina/WASM legacy lane | 2.87M/s | 1.00s |

### hardware-targets

| # | 🚦 | Runtime | Throughput | Wall | CPU | RSS | Heap/op | vs Python | vs Node |
|---|---|---|---|---|---|---|---|---|---|
| 🥇 | 🟢 | Galerina/WASM legacy lane | 36.32M/s | 1.00s | 1.00s | 106.8MB | ~0 | — | 40.4× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina governed ⟨interp⟩ (92.4 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 4 | ⚪ | Galerina/WASM legacy lane | 469.03M/s | 1.00s | 1.00s | 107.1MB | ~0 | 178.3× | 0.65× |
...
| 4 | 🟡 | Galerina/WASM legacy lane | 467.31M/s | 1.07s | 1.08s | 107.7MB | ~0 | 88.9× | 0.47× |
...
| 6 | ⚪ | Galerina/WASM legacy lane | 439.66M/s | 1.04s | 1.05s | 107.8MB | ~0 | 0.02× | 0.71× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (1.3 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 4 | 🟡 | Galerina/WASM legacy lane | 467.19M/s | 1.28s | 1.28s | 109.5MB | ~0 | 72.1× | 0.47× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (533 B/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 🥉 | 🟢 | Galerina/WASM legacy lane | 54.12M/s | 1.85s | 1.84s | 110.0MB | ~0 | 42.7× | 1.28× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (17.7 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 🥈 | 🟡 | Galerina/WASM legacy lane | 28.90M/s | 1.13s | 1.13s | 111.7MB | ~0 | 29.7× | 0.23× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (15.7 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| 🥉 | 🟢 | Galerina/WASM legacy lane | 9.03M/s | 1.82s | 1.81s | 117.1MB | ~0 | 67.8× | 1.44× |
...
> 🧠 **Lowest heap/op:** Galerina/WASM legacy lane (~0) · **highest:** Galerina passive ⟨interp⟩ (132.2 KB/op). Native Rust/C++ allocate ~0 (no GC heap); a positive figure is GC-managed allocation pressure.
...
| # | 🚦 | Runtime | Throughput | Wall | CPU | RSS | Heap/op | vs Python | vs Node |
|---|---|---|---|---|---|---|---|---|---|
| 🥇 | 🟢 | Galerina/WASM legacy lane | 584.53M/s | 1.16s | 1.16s | 116.0MB | ~0 | 202.8× | 7.42× |
...
| 4 | 🟡 | Galerina/WASM legacy lane | 🖥️ CPU (cpu (wasm)) | 467.31M/s | 1.07s | 0.47× |
...
| **hardware-targets** | Galerina/WASM legacy lane | **31× slower** | **31× slower** | **40× slower** | not run | **425× slower** | **12.3K× slower** | **9.1K× slower** | **🏆 winner** | not run — no GPU path |
...
| **binary-trees** | Galerina/WASM legacy lane | **40× slower** | **35× slower** | 7× slower | **203× slower** | **1.6K× slower** | **1.7K× slower** | **1.8K× slower** | **🏆 winner** | not run — no GPU path |
...
| 4 | Galerina/WASM legacy lane | 75.04M/s | 1.8× slower | 104× faster |
...
| 4 | Galerina/WASM legacy lane | 489.53M/s | 3.2× slower | 13.7K× faster |
...
| 🥉 | Galerina/WASM legacy lane | 36.43M/s | 2.1× slower | 1.5K× faster |
...
| 🥉 | Galerina/WASM legacy lane | 542.58M/s | 2.2× slower | 242× faster |
...
| 🥈 | Galerina/WASM legacy lane | 17.2K/s | 4.3× slower | 4.4K× faster |
...
| 4 | Galerina/WASM legacy lane | 121.55M/s | 2.1× slower | 1.5K× faster |
...
| 🥉 | Galerina/WASM legacy lane | 416.74M/s | 32× slower | 200× faster |
...
| # | Runtime | Throughput | ×vs winner | ×vs slowest |
|---|---|---|---|---|
| 🥇 | Galerina/WASM legacy lane | 36.32M/s | 🏆 winner | 12.3K× faster |
...
| 4 | Galerina/WASM legacy lane | 469.03M/s | 13× slower | 4.1K× faster |
...
| 4 | Galerina/WASM legacy lane | 467.31M/s | 2.5× slower | 1.5K× faster |
...
| 6 | Galerina/WASM legacy lane | 439.66M/s | 64× slower | 718× faster |
...
| 4 | Galerina/WASM legacy lane | 467.19M/s | 3.0× slower | 1.5K× faster |
...
| 🥉 | Galerina/WASM legacy lane | 54.12M/s | 2.9× slower | 1.1K× faster |
...
| 🥈 | Galerina/WASM legacy lane | 28.90M/s | 4.3× slower | 510× faster |
...
| 🥉 | Galerina/WASM legacy lane | 9.03M/s | 2.6× slower | 1.3K× faster |
...
| # | Runtime | Throughput | ×vs winner | ×vs slowest |
|---|---|---|---|---|
| 🥇 | Galerina/WASM legacy lane | 584.53M/s | 🏆 winner | 1.8K× faster |
