...
function buildWorkspace(root) {
  ...
  for (const packagePathValue of workspace.packages) {
    ...
    if (packagePath === null || !packagePath.startsWith("packages-galerina/")) {
  ...
  const compilerPath = canonicalChangedPath(workspace.compilerPackage ?? "packages-galerina/galerina-core-compiler");
