...
```powershell
node packages-galerina/galerina-devtools-impact/bin/galerina-impact.mjs --base HEAD --json
...
The package is a single flat peer under `packages-galerina`. It has no external
