...
**v1.0.0-beta.2 · 100 packages · 9470 tests · ship-readiness 100.0% · Zero-Trust thesis avg 78% · build avg 75%**
...
| **Execution cutover** (governed decision surfaces → signed WASM/SLIDE) | ◑ bounded authority | **29 authoritative** `.fungi` specifications · 7 differential candidates · bounded independent SLIDE execution at 857/857 · mandatory `restoreVerdict` consumer switch 4/4 (reference-only) · TypeScript retained until production composition and terminal retirement gates close |
