...
**v1.0.0-beta.2 · 96 packages · 8524 tests · ship-readiness 97.9% · Zero-Trust thesis avg 78% · build avg 75%**

![Galerina roadmap — subway map](build/component-health/roadmap-subway.svg)

**Self-hosting line (RD-0528).** 5 of 7 compiler stages are AUTHORITATIVE — the `.fungi` stage is the decider of record and the co-located `.ts` is retained as a running differential shadow. All 7 are byte-pinned in the stage-hash baseline.

| stage | lexer | parser | type-checker | effect-checker | gir-emitter | governance-verifier | runtime |
|---|---|---|---|---|---|---|---|
| authority | ● | ○ | ● | ● | ● | ○ | ● |

**Kernel cutover line (RD-0361).** 9 sentinel twins are authoritative in the ledger. The differential remainder is not counted here — no ledger records a denominator, and inventing one would be a hand-typed number.
...
**v1.0.0-beta.2 · full suite 96/96 test-bearing packages · 8,524 tests · 0 failures.**
...
| **Tests** | ✅ green | 96/96 · 8,524 · 0 fail |
