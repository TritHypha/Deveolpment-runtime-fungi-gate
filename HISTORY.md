...
> `../ZTF-Knowledge-Bases/reference/galerina/galerina-runtime-status-SOT.md` (the source of truth).
> For the build roadmap, see `../ZTF-Knowledge-Bases/reference/galerina/galerina-build-roadmap.md`.
