(module
  ...
  ;; pure flow: validateOpticalSignal
  (func $validateOpticalSignal (param $p0 i32) (param $p1 i32) (result i32)
    ...
    (if (i32.or (i32.eq (call $fungi_is_finite_f64 (f64.load (i32.add (i32.load (i32.add (local.get $p0) (i32.const 0))) (i32.const 0)))) (i32.const 0)) (f64.le (call $fungi_assert_finite_f64 (f64.load (i32.add (i32.load (i32.add (local.get $p0) (i32.const 0))) (i32.const 0)))) (call $fungi_assert_finite_f64 (f64.const 0.0))))
      (then
    ...
    (if (i32.eq (call $fungi_is_finite_f64 (f64.load (i32.add (i32.load (i32.add (local.get $p0) (i32.const 4))) (i32.const 0)))) (i32.const 0))
      (then
        (local.set $diagnostics (call $host___array_append (local.get $diagnostics) (block (result i32)
    ...
    (if (i32.or (i32.or (i32.eq (call $fungi_is_finite_f64 (f64.load (i32.add (i32.load (i32.add (local.get $p0) (i32.const 8))) (i32.const 0)))) (i32.const 0)) (f64.lt (call $fungi_assert_finite_f64 (f64.load (i32.add (i32.load (i32.add (local.get $p0) (i32.const 8))) (i32.const 0)))) (call $fungi_assert_finite_f64 (f64.const 0.0)))) (f64.gt (call $fungi_assert_finite_f64 (f64.load (i32.add (i32.load (i32.add (local.get $p0) (i32.const 8))) (i32.const 0)))) (call $fungi_assert_finite_f64 (f64.const 1.0))))
      (then
        (local.set $diagnostics (call $host___array_append (local.get $diagnostics) (block (result i32)
  ...
  (export "validateOpticalSignal" (func $validateOpticalSignal))
