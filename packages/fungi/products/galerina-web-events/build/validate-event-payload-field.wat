(module
  ...
  (func $validateEventPayloadFieldAtPath (param $p0 i32) (param $p1 i32) (result i32)
    ...
    (if (i32.eq (local.get $knownKind) (i32.const 0))
      ...
      (i32.store (i32.add (local.get $__fungi_rec_1) (i32.const 12)) (call $host___str_concat (local.get $p1) (i32.const 13))) ;; .path
  ...
  (export "validateEventPayloadFieldAtPath" (func $validateEventPayloadFieldAtPath))

  ;; pure flow: validateEventPayloadField
  (func $validateEventPayloadField (param $p0 i32) (result i32)
    ...
    (call $validateEventPayloadFieldAtPath (local.get $p0) (i32.const 14))
  )
  (export "validateEventPayloadField" (func $validateEventPayloadField))
