(module
  ...
  (func $validateApiToStateConversionAtPath (param $p0 i32) (param $p1 i32) (result i32)
  ...
  (export "validateApiToStateConversionAtPath" (func $validateApiToStateConversionAtPath))

  ;; pure flow: validateApiToStateConversion
  (func $validateApiToStateConversion (param $p0 i32) (result i32)
    ...
    (call $validateApiToStateConversionAtPath (local.get $p0) (i32.const 8))
  )
  (export "validateApiToStateConversion" (func $validateApiToStateConversion))
