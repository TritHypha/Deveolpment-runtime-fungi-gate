(module
  ...
  ;; pure flow: validateFirestoreCredentialRef
  (func $validateFirestoreCredentialRef (param $p0 i32) (param $p1 i32) (result i32)
  ...
  (export "validateFirestoreCredentialRef" (func $validateFirestoreCredentialRef))
