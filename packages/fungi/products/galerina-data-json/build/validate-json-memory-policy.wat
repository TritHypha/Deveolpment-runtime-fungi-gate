(module
  ...
  (func $validateJsonMemoryPolicy (param $p0 i32) (param $p1 i32) (result i32)
    ...
    (if (call $host___option_is_none_v2 (local.get $__fungi_match_0))
      ...
      (else
        ...
        (if (i32.eq (call $isPositiveSafeInteger (local.get $__fungi_match_1)) (i32.const 0))
          (then
            (local.set $diagnostics (call $host___array_append (local.get $diagnostics) (block (result i32)
      ...
      (i32.store (i32.add (local.get $__fungi_rec_2) (i32.const 12)) (call $host___str_concat (local.get $p1) (i32.const 13))) ;; .path
  ...
  (export "validateJsonMemoryPolicy" (func $validateJsonMemoryPolicy))

  ;; pure flow: validateJsonMemoryPolicyDefault
  (func $validateJsonMemoryPolicyDefault (param $p0 i32) (result i32)
    ...
    (call $validateJsonMemoryPolicy (local.get $p0) (i32.const 14))
  )
  (export "validateJsonMemoryPolicyDefault" (func $validateJsonMemoryPolicyDefault))
