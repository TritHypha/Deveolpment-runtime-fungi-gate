(module
  ...
  (func $validateMysqlCredentialRefAtPath (param $p0 i32) (param $p1 i32) (result i32)
  ...
  (export "validateMysqlCredentialRefAtPath" (func $validateMysqlCredentialRefAtPath))

  ;; pure flow: validateMysqlCredentialRef
  (func $validateMysqlCredentialRef (param $p0 i32) (result i32)
    ...
    (call $validateMysqlCredentialRefAtPath (local.get $p0) (i32.const 17))
  )
  (export "validateMysqlCredentialRef" (func $validateMysqlCredentialRef))
