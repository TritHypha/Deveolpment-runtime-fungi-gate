(module
  ...
  (func $validateDatabaseChecksumAtPath (param $p0 i32) (param $p1 i32) (result i32)
    ...
    (if (i32.eq (local.get $expectedLength) (i32.const 0))
      ...
      (i32.store (i32.add (local.get $__fungi_rec_0) (i32.const 8)) (call $host___str_concat (call $host___str_concat (call $host___str_concat (call $host___str_concat (i32.const 7) (call $host___int_to_str (call $host___char_from_code (i32.const 34)))) (i32.load (i32.add (local.get $p0) (i32.const 0)))) (call $host___int_to_str (call $host___char_from_code (i32.const 34)))) (i32.const 8))) ;; .message
  ...
  (export "validateDatabaseChecksumAtPath" (func $validateDatabaseChecksumAtPath))

  ;; pure flow: validateDatabaseChecksum
  (func $validateDatabaseChecksum (param $p0 i32) (result i32)
    ...
    (call $validateDatabaseChecksumAtPath (local.get $p0) (i32.const 15))
  )
  (export "validateDatabaseChecksum" (func $validateDatabaseChecksum))
