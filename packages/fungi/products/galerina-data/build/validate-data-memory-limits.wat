(module
  ...
  (func $validateDataMemoryLimits (param $p0 i32) (param $p1 i32) (result i32)
    ...
    (if (i32.eq (call $isPositiveSafeInteger (f64.load (i32.add (local.get $p0) (i32.const 8)))) (i32.const 0))
      ...
      (global.set $__fungi_heap (i32.add (global.get $__fungi_heap) (i32.const 16)))
      (i32.store (i32.add (local.get $__fungi_rec_1) (i32.const 0)) (i32.const 4)) ;; .code
      ...
      (i32.store (i32.add (local.get $__fungi_rec_1) (i32.const 12)) (call $host___str_concat (local.get $p1) (i32.const 9))) ;; .path
    ...
    (if (i32.eq (call $isPositiveSafeInteger (f64.load (i32.add (local.get $p0) (i32.const 16)))) (i32.const 0))
      ...
      (i32.store (i32.add (local.get $__fungi_rec_2) (i32.const 8)) (i32.const 11)) ;; .message
      (i32.store (i32.add (local.get $__fungi_rec_2) (i32.const 12)) (call $host___str_concat (local.get $p1) (i32.const 12))) ;; .path
  ...
  (export "validateDataMemoryLimits" (func $validateDataMemoryLimits))

  ;; pure flow: validateDataMemoryLimitsDefault
  (func $validateDataMemoryLimitsDefault (param $p0 i32) (result i32)
    ...
    (call $validateDataMemoryLimits (local.get $p0) (i32.const 13))
  )
  (export "validateDataMemoryLimitsDefault" (func $validateDataMemoryLimitsDefault))
