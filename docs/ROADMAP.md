...
**v1.0.0-beta.2 · 100 packages · 9612 tests · ship-readiness 100.0% · Zero-Trust thesis avg 78% · build avg 73%**

**Assurance DAG: UNKNOWN** · root `fda5c9c04612b73fcd984ffd8344c787efca904f1999f07e0fc0035a196c07d9` · non-authorizing.
...
> **Read the map honestly: 3 of 19 percentages are measured** (a live reading or a countable ladder); the remaining 16 are asserted — a considered judgement, but hand-typed. Burning that ratio down is itself tracked work, which is why the map draws the difference instead of hiding it.
