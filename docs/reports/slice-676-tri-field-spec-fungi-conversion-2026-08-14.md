# Slice 676 TriFieldSpec Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#TriFieldSpec`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version requirement and optional predicate declaration; it confers no runtime authority.

Minimum vectors: Missing/surplus fields; optional verifier; readonly erasure and external compatibility.
