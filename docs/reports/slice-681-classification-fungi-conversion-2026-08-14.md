# Slice 681 Classification Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#Classification`.

`NO_RUNTIME_BEHAVIOR` (ERASED_UNION_RETAIN_DECLARATION): Retain/version the exact public three-label declaration.
