# Slice 320 FrameworkAdapterMetadata Fungi conversion adjudication

`FrameworkAdapterMetadata` is an erased interface with `NO_RUNTIME_BEHAVIOR`;
it validates no framework identity, version, mount point or typed absence.
...
13/13; no twin. Exact optional text, bounds, hostile fields and provenance are
prerequisites.
