# Slice 673 ContractOutcome Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#ContractOutcome`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public null-bearing result declaration or govern exact binding generation.

Minimum vectors: Exact fields, mode/verdict/proceed/violated relations and declaration compatibility.
