# Slice 315 JsModuleFormat Fungi conversion adjudication

`JsModuleFormat` is an erased two-string alias with `NO_RUNTIME_BEHAVIOR`.
...
13/13; no twin. Exact `esm|cjs`, wrong/case/hostile values and runtime-format
relations require closed decoding.
