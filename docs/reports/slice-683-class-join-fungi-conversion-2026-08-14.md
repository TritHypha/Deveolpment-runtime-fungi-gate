# Slice 683 classJoin Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#classJoin`.

`BLOCKED` (BLOCKED_BY_ERASED_CLASSIFICATION_INGRESS_AND_EXHAUSTIVE_LATTICE_ABI): Decode closed classification tags and prove all nine pairs plus terminal refusal physically.

Minimum vectors: All 9 pairs; commutativity/idempotence; invalid a/b; accessor/proxy border.
