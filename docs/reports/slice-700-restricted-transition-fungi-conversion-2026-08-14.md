# Slice 700 governance-enforcer.ts#RestrictedTransition Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/governance-enforcer.ts#RestrictedTransition`.
...
Minimum vectors: Exact readonly fields and broad number domain.
