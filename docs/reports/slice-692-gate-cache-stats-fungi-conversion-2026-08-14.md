# Slice 692 GateCacheStats Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/gate-cache.ts#GateCacheStats`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public declaration or prove exact generated binding and consumers.

Minimum vectors: Exact nonnegative integer fields; unsafe/overflow; declaration compatibility.
