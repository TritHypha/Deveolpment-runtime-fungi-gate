# Slice 922 src/substrate-erasure.ts#SubstrateAttestationManifest Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/substrate-erasure.ts#SubstrateAttestationManifest`.

`NO_RUNTIME_BEHAVIOR` (PUBLIC_DTS_DECLARATION). Exact exit: retain and version the exact public schema/id/model/capability/optional signer declaration until governed bindings replace every consumer.

Minimum vectors: all fields; both models; signer absent/undefined/present; missing/surplus/inherited/accessor/proxy; readonly erasure.
