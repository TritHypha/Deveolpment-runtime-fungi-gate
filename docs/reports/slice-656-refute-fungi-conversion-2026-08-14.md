# Slice 656 refute Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#refute`.

`BLOCKED` (BLOCKED_BY_ACTIVE_RECORD_PAYLOAD_PROVENANCE_ALIAS_AND_MUTABLE_TRUST_ABI): Require immutable exact record/provenance, payload ownership, stable Trust and physical admission.

Minimum vectors: Primitive/object alias; result/provenance mutation; reason controls/coercion; Trust mapping tamper.
