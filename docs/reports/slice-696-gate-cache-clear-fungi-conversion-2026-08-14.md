# Slice 696 GateCache.clear Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/gate-cache.ts#GateCache.clear`.

`BLOCKED` (BLOCKED_BY_ORDERED_MAP_AND_COUNTER_RESET_ABI): Prove atomic/exclusive table and counter reset with alias/lifecycle settlement and physical state evidence.

Minimum vectors: Empty/populated/repeated; outstanding aliases; operation ordering; partial reset/failure.
