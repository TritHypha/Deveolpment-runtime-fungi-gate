# Slice 672 EnforcementMode Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#EnforcementMode`.

`NO_RUNTIME_BEHAVIOR` (ERASED_UNION_RETAIN_DECLARATION): Retain/version the exact three-label declaration; it supplies no runtime mode decoder.

Minimum vectors: All three labels plus case/surplus/wrong class; declaration consumers.
