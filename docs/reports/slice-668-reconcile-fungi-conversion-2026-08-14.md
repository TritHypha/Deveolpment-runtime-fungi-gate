# Slice 668 reconcile Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#reconcile`.

`BLOCKED` (BLOCKED_BY_CALLER_SUPPLIED_TRUST_LIFT_CALLBACK_EXCEPTION_AND_RECEIPT_ABI): Require a provenance-bound verifier capability and immutable receipt tied to the exact payload snapshot.

Minimum vectors: Every trust; verifier true/false/throw/non-Bool; hostile always-true; mutation; getter/proxy; provenance order.
