# Slice 686 combineTriTyped Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#combineTriTyped`.

`BLOCKED` (BLOCKED_BY_ACTIVE_CALLBACK_ALIAS_PROVENANCE_AND_DUAL_AXIS_PHYSICAL_ABI): Admit callback effects/failure, exact K3 min and class join, immutable snapshots/provenance and physical dual-axis proof.

Minimum vectors: 9 trust pairs x 9 class pairs; callback throw/mutate; getter/proxy; provenance alias/order.
