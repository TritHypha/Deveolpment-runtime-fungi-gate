# Slice 603 ELLIPSIS_RE Fungi conversion adjudication

Scope: `packages-galerina/galerina-tools-myco/src/query/links.ts#ELLIPSIS_RE`.

`BLOCKED` (BLOCKED_HEURISTIC_ELLIPSIS_REGEXP_UTF16_AND_MIRROR_CUSTODY): Keep heuristic output non-authorizing and prove exact regex/String semantics.

Minimum vectors: three and four dots; traversal-like dots; suffix text; dotfile controls; percent encoding and lone surrogates.
