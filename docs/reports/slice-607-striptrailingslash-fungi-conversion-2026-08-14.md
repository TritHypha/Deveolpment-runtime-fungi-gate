# Slice 607 stripTrailingSlash Fungi conversion adjudication

Scope: `packages-galerina/galerina-tools-myco/src/query/links.ts#stripTrailingSlash`.

`BLOCKED` (BLOCKED_JS_STRING_LENGTH_ENDSWITH_SLICE_AND_PHYSICAL_STRING_ABI): Prove exact endsWith/slice semantics and the selected physical String profile.

Minimum vectors: empty, root, one/double trailing slash, backslash, controls, astral/lone surrogate, wrong class.
