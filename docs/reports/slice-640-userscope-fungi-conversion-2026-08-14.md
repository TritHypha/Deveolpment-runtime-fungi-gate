# Slice 640 UserScope Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/data-plane-border.ts#UserScope`.

`NO_RUNTIME_BEHAVIOR` (ERASED_TYPE_RETAIN_DECLARATION): Retain/version the public type; ReadonlySet is not cryptographic provenance.

Minimum vectors: real/fake Set; SameValueZero; mutation; structural forgery; declaration compatibility.
