# Slice 619 SignedCapabilityGrant Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/capability-grant.ts#SignedCapabilityGrant`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the declaration; signature runtime behavior belongs to Slices623-625.

Minimum vectors: absent/present signatures; malformed base64; nested grant alias; surplus/accessor/proxy fields.
