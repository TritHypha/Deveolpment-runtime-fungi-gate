# Slice 690 canonicalPolicyInput Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/gate-cache.ts#canonicalPolicyInput`.

`BLOCKED` (BLOCKED_BY_NON_INJECTIVE_ACTIVE_JSON_POLICY_CANONICALIZATION): Decode one inert governance snapshot and use a versioned injective byte protocol that distinguishes all admitted states or refuses them.

Minimum vectors: Order/duplicates/holes; undefined/null/NaN/infinity/-0/BigInt; Unicode; getters/proxy/toJSON/mutation.
