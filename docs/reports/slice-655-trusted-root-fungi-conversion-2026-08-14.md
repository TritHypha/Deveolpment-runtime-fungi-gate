# Slice 655 trustedRoot Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#trustedRoot`.

`BLOCKED` (BLOCKED_BY_CALLER_MINTABLE_TRUST_ROOT_AUTHORITY): Remove unchecked PROVEN minting or require a provenance-bound Hallmark/capability/signed root receipt tied to payload, reason and policy.

Minimum vectors: Arbitrary forged payload; empty/control reason; replay/cross-context; post-mint mutation; coercion throw.
