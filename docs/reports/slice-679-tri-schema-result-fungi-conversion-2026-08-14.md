# Slice 679 TriSchemaResult Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#TriSchemaResult`.

`NO_RUNTIME_BEHAVIOR` (ERASED_MAPPED_RESULT_RETAIN_DECLARATION): Retain/version mapped fields, Partial known and nullable diagnostic declaration.

Minimum vectors: Exact mapped fields/known/verdict/diagnostic; declaration compatibility.
