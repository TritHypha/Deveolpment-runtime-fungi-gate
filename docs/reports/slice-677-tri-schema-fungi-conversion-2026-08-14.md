# Slice 677 TriSchema Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#TriSchema`.

`NO_RUNTIME_BEHAVIOR` (ERASED_MAPPED_TYPE_RETAIN_DECLARATION): Retain/version the mapped-key declaration or prove exact generated binding and consumers.

Minimum vectors: Key mapping, symbol/surplus behavior and declaration compatibility.
