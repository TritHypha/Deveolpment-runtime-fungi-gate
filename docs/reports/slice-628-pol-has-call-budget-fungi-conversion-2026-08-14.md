# Slice 628 POL_HAS_CALL_BUDGET Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/compiled-policy.ts#POL_HAS_CALL_BUDGET`.

`CANDIDATE` (CANDIDATE_PRIMITIVE_INT_REQUIRES_PHYSICAL_PROOF): Author an exact package-owned Int 4 twin, GIR/physical proof and consumer switch before supersession.

Minimum vectors: 3/4/5; exact bit position; flag combination controls.
