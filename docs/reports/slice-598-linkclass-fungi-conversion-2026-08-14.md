# Slice 598 LinkClass Fungi conversion adjudication

Scope: `packages-galerina/galerina-tools-myco/src/query/links.ts#LinkClass`.

`NO_RUNTIME_BEHAVIOR` (ERASED_UNION_RETAIN_DECLARATION): Retain or version the emitted TypeScript union; no runtime or retirement credit.

Minimum vectors: all six exact literals; case, surplus and wrong-class tags; declaration-consumer compatibility.
