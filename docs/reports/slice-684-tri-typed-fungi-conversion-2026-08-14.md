# Slice 684 TriTyped Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#TriTyped`.

`NO_RUNTIME_BEHAVIOR` (ERASED_GENERIC_INTERFACE_RETAIN_DECLARATION): Retain/version the generic public declaration or exact governed generator output.

Minimum vectors: Exact fields, payload/trust/class domains, provenance and readonly erasure.
