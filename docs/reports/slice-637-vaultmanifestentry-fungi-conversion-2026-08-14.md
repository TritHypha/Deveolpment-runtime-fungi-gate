# Slice 637 VaultManifestEntry Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/data-plane-border.ts#VaultManifestEntry`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public declaration or prove exact governed schema generation.

Minimum vectors: exact visibility token; missing/surplus/accessor/proxy fields; declaration compatibility.
