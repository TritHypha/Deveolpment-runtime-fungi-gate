# Slice 651 Trusted Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#Trusted`.
...
Minimum vectors: Exact K=PROVEN and structural/readonly compatibility.
