# Slice 632 CompiledPolicy Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/compiled-policy.ts#CompiledPolicy`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the declaration; active compiled state belongs to compilePolicy.

Minimum vectors: flags/budgets; active Set; optional trap; missing/surplus/accessor/proxy fields.
