# Slice 316 SourceMapMode Fungi conversion adjudication

`SourceMapMode` is an erased three-string alias with `NO_RUNTIME_BEHAVIOR`.
...
13/13; no twin. Exact tags, surplus/case/wrong/hostile values require refusal.
