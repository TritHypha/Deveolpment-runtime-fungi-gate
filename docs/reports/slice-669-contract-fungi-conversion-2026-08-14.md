# Slice 669 Contract Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#Contract`.

`NO_RUNTIME_BEHAVIOR` (ERASED_CALLBACK_TYPE_RETAIN_DECLARATION): Retain/version the public callback declaration; its return annotation provides no runtime Verdict validation.

Minimum vectors: Exact callback signature and consumer compatibility; invalid runtime results remain consumer blockers.
