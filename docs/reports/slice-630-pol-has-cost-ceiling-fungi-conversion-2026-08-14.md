# Slice 630 POL_HAS_COST_CEILING Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/compiled-policy.ts#POL_HAS_COST_CEILING`.

`CANDIDATE` (CANDIDATE_PRIMITIVE_INT_REQUIRES_PHYSICAL_PROOF): Author an exact package-owned Int 16 twin, GIR/physical proof and consumer switch before supersession.

Minimum vectors: 15/16/17; exact bit position; flag combination controls.
