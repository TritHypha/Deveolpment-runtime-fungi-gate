# Slice 924 src/substrate-erasure.ts#SubstrateAdmissionPolicy Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/substrate-erasure.ts#SubstrateAdmissionPolicy`.

`NO_RUNTIME_BEHAVIOR` (PUBLIC_DTS_DECLARATION). Exact exit: retain and version the PEM, capability-array and revocation-callback declaration; readonly typing supplies no runtime provenance.

Minimum vectors: PEM classes; mutable/sparse capabilities; callback absent/present/throw/foreign; missing/surplus/proxy; readonly erasure.
