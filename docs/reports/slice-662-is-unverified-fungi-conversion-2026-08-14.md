# Slice 662 isUnverified Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#isUnverified`.

`BLOCKED` (BLOCKED_BY_FORGEABLE_TAG_ONLY_TRUST_GUARD): Require exact-record validation, stable Trust and provenance-bound receipt before the guard carries authority.

Minimum vectors: Forged trust=0; missing/inherited/accessor/proxy fields; wrong class; post-check mutation and singleton tamper.
