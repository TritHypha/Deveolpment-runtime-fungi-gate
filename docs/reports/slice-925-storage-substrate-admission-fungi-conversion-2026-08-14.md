# Slice 925 src/substrate-erasure.ts#StorageSubstrateAdmission Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/substrate-erasure.ts#StorageSubstrateAdmission`.

`NO_RUNTIME_BEHAVIOR` (PUBLIC_DTS_DECLARATION). Exact exit: retain and version the decision/descriptor/reason declaration until governed bindings preserve every field and consumer.

Minimum vectors: all Verdict/authorized relations; descriptor null/record; admitted consistency; reason controls; aliases/mutation.
