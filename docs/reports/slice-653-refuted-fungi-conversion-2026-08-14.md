# Slice 653 Refuted Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#Refuted`.
...
Minimum vectors: Exact K=REFUTED and structural/readonly compatibility.
