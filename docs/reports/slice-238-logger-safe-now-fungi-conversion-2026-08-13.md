# Slice 238 Logger.#safeNow Fungi conversion adjudication

## Outcome

`Logger.#safeNow` is `BLOCKED_BY_RETAINED_CLOCK_CALLBACK_BINARY64_NORMALISATION_ABI`. It invokes a retained callback, preserves every finite JavaScript number and maps non-finite or thrown outcomes to zero. No placeholder Fungi asset is created.

Required exit: Admit a clock capability and the complete binary64, signed-zero and failure-to-zero contract.
