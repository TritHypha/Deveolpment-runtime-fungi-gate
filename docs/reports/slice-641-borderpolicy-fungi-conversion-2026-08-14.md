# Slice 641 BorderPolicy Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/data-plane-border.ts#BorderPolicy`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public declaration; runtime policy authority remains separate.

Minimum vectors: registry/shared scope absent/present; forged Set; missing/surplus/accessor/proxy fields.
