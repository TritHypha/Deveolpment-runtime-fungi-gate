# Slice 663 isRefuted Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#isRefuted`.
...
Minimum vectors: Forged trust=-1; missing/inherited/accessor/proxy fields; wrong class; post-check mutation and singleton tamper.
