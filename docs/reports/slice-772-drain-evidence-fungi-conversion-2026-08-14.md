# Slice 772 src/key-rotation.ts#DrainEvidence Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/key-rotation.ts#DrainEvidence`.

`NO_RUNTIME_BEHAVIOR` (PUBLIC_DTS_DECLARATION). Exact exit: retain and version the public declaration until governed bindings preserve counts, votes and consumers.

Minimum vectors: missing/surplus fields, numeric boundaries, vote-array aliases and declaration compatibility.
