# Slice 227 JsonLineSink.constructor Fungi conversion adjudication

## Outcome

`JsonLineSink.constructor` is `BLOCKED_BY_RETAINED_LINE_WRITER_CAPABILITY_ABI`. It retains an unrestricted caller-supplied callback for later output. No placeholder Fungi asset is created.

Required exit: Admit a scoped writer lease with grant, revocation, exact failure and output-order contracts.
