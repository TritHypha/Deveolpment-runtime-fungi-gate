# Slice 629 POL_HAS_TOKEN_BUDGET Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/compiled-policy.ts#POL_HAS_TOKEN_BUDGET`.

`CANDIDATE` (CANDIDATE_PRIMITIVE_INT_REQUIRES_PHYSICAL_PROOF): Author an exact package-owned Int 8 twin, GIR/physical proof and consumer switch before supersession.

Minimum vectors: 7/8/9; exact bit position; flag combination controls.

Evidence: source build point `674aad9d956acc67eafceb5497cf97c7a0ab96ec`;
source SHA-256 `C0807BACCD00CD8784CCA12156108C5EE5EA8F2BDA4463102F0803AC54E7BDE0`; live scoped bytes remain identical through the authored plan. Fresh Tower no-emit typecheck and 515/515 existing tests pass. These checks are regression evidence only. No exact scoped Fungi/GIR/physical `.slide`/independent re-admission/VOK replacement, consumer switch or TypeScript/JavaScript retirement exists.
