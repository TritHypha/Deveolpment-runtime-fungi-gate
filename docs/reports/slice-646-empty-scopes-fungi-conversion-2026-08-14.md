# Slice 646 EMPTY_SCOPES Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/data-plane-border.ts#EMPTY_SCOPES`.

`BLOCKED` (BLOCKED_BY_ACTIVE_READONLYSET_IDENTITY_ABI): Eliminate only in a cohesive rewrite or admit exact active Set identity and prototype-dispatch semantics.

Minimum vectors: empty membership; repeated identity; prototype tampering; absence/undefined behavior; no alias escape.
