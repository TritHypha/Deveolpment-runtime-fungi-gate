# Slice 618 CapabilityGrant Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/capability-grant.ts#CapabilityGrant`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the declaration; cryptographic runtime behavior belongs to Slices621-625.

Minimum vectors: engine identity; mask extrema; optional grantId; missing/surplus/accessor/proxy fields.
