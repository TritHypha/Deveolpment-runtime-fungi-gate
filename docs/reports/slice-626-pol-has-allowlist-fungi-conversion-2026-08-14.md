# Slice 626 POL_HAS_ALLOWLIST Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/compiled-policy.ts#POL_HAS_ALLOWLIST`.

`CANDIDATE` (CANDIDATE_PRIMITIVE_INT_REQUIRES_PHYSICAL_PROOF): Author an exact package-owned Int 1 twin, GIR/physical proof and consumer switch before supersession.

Minimum vectors: 0/1/2; exact bit position; flag combination controls.
