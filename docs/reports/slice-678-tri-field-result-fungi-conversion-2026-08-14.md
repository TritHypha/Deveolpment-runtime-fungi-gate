# Slice 678 TriFieldResult Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#TriFieldResult`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public field-result declaration.

Minimum vectors: Exact fields/classes; trust/note invariants; readonly erasure.
