# Slice 233 Logger.warn Fungi conversion adjudication

## Outcome

`Logger.warn` is `BLOCKED_BY_ACTIVE_STRUCTURED_LOG_EMISSION_AND_THIS_IDENTITY_ABI`. A fixed level does not remove the retained state and effect graph. No placeholder Fungi asset is created.
