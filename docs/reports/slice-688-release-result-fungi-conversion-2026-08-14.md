# Slice 688 ReleaseResult Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#ReleaseResult`.

`NO_RUNTIME_BEHAVIOR` (ERASED_GENERIC_INTERFACE_RETAIN_DECLARATION): Retain/version the null-bearing generic declaration or exact governed binding.

Minimum vectors: Exact fields and authorized/value dependency; Option-vs-null compatibility.
