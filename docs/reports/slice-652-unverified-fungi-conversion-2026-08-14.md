# Slice 652 Unverified Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#Unverified`.

`NO_RUNTIME_BEHAVIOR` (PUBLIC_DTS_DECLARATION): Retain/version the public literal-K declaration until governed declaration generation and consumer migration are proved.

Minimum vectors: Exact K=UNKNOWN and structural/readonly compatibility.
