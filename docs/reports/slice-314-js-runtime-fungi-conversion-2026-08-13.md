# Slice 314 JsRuntime Fungi conversion adjudication

`JsRuntime` is an erased two-string alias with `NO_RUNTIME_BEHAVIOR`.
...
tests 13/13; no Fungi/GIR/SLIDE/VOK twin. Exact tags and hostile surplus values
require closed admission before runtime-specific policy.
