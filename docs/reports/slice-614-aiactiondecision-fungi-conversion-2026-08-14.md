# Slice 614 AiActionDecision Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/ai-governance.ts#AiActionDecision`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public declaration; runtime semantics belong to governAiProposal.

Minimum vectors: missing/surplus fields; Verdict domain; action identity; developer-contract compatibility.
