# Slice 639 DataRow Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/data-plane-border.ts#DataRow`.

`NO_RUNTIME_BEHAVIOR` (ERASED_INTERFACE_RETAIN_DECLARATION): Retain/version the public declaration; runtime row admission remains separate.

Minimum vectors: owner/vault strings; missing/surplus/accessor/proxy fields; mutation; declaration compatibility.
