# Slice 558 SearchOutcome Fungi conversion adjudication

Scope: `packages-galerina/galerina-tools-myco/src/query/search.ts#SearchOutcome`.

`NO_RUNTIME_BEHAVIOR` (ERASED_UNION_RETAIN_DECLARATION): This declaration is erased at runtime. Retain or version its exact TypeScript developer contract; no placeholder Fungi execution authority or source retirement follows.
