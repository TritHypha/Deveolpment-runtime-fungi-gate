# Slice 242 createLogger Fungi conversion adjudication

## Outcome

`createLogger` is `BLOCKED_BY_ACTIVE_LOGGER_OBJECT_CAPABILITY_ABI`. Constructing and returning a Logger transfers retained sink, clock, fields, redaction and mutable counter authority. No placeholder Fungi asset is created.

Required exit: Admit the exact active-object lifecycle and all retained capability grants before returning it.
