# Slice 675 FieldRequirement Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#FieldRequirement`.

`NO_RUNTIME_BEHAVIOR` (ERASED_UNION_RETAIN_DECLARATION): Retain/version the exact three-label public declaration.

Minimum vectors: All labels plus surplus/wrong class and declaration compatibility.
