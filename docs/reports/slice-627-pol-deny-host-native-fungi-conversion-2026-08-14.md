# Slice 627 POL_DENY_HOST_NATIVE Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/compiled-policy.ts#POL_DENY_HOST_NATIVE`.

`CANDIDATE` (CANDIDATE_PRIMITIVE_INT_REQUIRES_PHYSICAL_PROOF): Author an exact package-owned Int 2 twin, GIR/physical proof and consumer switch before supersession.

Minimum vectors: 1/2/3; exact bit position; flag combination controls.
