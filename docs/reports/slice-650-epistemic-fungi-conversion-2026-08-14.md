# Slice 650 Epistemic Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#Epistemic`.

`NO_RUNTIME_BEHAVIOR` (PUBLIC_DTS_DECLARATION): Retain/version the exact generic public declaration or replace it through governed binding generation with all consumers proved.

Minimum vectors: Exact fields, generic K default/bounds, readonly erasure and structural compatibility.
