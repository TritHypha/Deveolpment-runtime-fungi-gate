# Slice 654 unverified Fungi conversion adjudication

Scope: `packages-galerina/galerina-tower-citizen/src/epistemic-type-state.ts#unverified`.

`BLOCKED` (BLOCKED_BY_ACTIVE_RECORD_PAYLOAD_PROVENANCE_ALIAS_AND_MUTABLE_TRUST_ABI): Require a closed immutable record, payload-ownership rule, stable Trust mapping and physical record/array/String admission.

Minimum vectors: Default/empty/control/Unicode reason; primitive/object payload; alias and post-return trust/provenance mutation.
