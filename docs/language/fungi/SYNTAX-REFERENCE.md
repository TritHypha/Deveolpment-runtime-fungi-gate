...
| direct `Authority<Tag>` transfer | passing, returning or rebinding transfers once; reuse refuses; records/lists/persistence refuse | [self-hosted VOK contract](../../../packages-ts/galerina-core-compiler/src/self-hosted/slide-vok-authority-types.fungi) | `FUNGI-AFFINE-002..004` |
