...
- **Governance is three-valued.** ALLOW / DENY / **INDETERMINATE** — an empty or unknown verdict is deny-by-default, never a silent yes ([K3](../../../packages-ts/galerina-tower-citizen/src/three-valued-governance.ts)).
