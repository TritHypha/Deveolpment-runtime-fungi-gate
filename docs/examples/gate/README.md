...
| **[SEMANTICS.md](SEMANTICS.md)** | **normative** — the rules a clean-room conformance verifier is derived from: single assignment, the K3 lattice, the semantic passes, and the stated boundaries |
