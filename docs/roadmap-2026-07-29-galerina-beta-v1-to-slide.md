...
**Assurance DAG: UNKNOWN** · root `45ff44189f61147f7816d1cfd0169a0ef7fee45575a60359dce9bcf2ebe468fa` · non-authorizing.
...
| Full Galerina publication benchmark | 🟩 controls / 🟨 SLIDE comparison | Date-stamped run `2026-08-12T17:19:05.632Z` binds Galerina `e5771ec5ab8c5f1834666c9ade319dab31578095`, SLIDE `6de4d91ba20a7e86c53c8898fcdae2ef4b6cee28`, and raw results `sha256:021f33c78d90ecba907a5f7381a0c9abe377509d356c65007f119207fde6af1b`. The full non-quick run exited 0 in 344.7 s; 18 comparable workloads align, six checksum controls pass and the truth audit is clean. Node 24.18.0, Python 3.14.6, Rust 1.96.1 and Go 1.26.5 are exact recorded controls; Go exists on only one workload and no C++ compiler was available. The chart and HTML table correctly return `DEFERRED_NO_SLIDE_LANE`, because no production `slide` lane exists; neither Wasm nor `slideReference` was promoted, so no winner or Galerina/SLIDE place was invented. Frozen Galerina/Wasm remains `2026-08-02_galerina-wasm-before-slide`, `sha256:abc564389dd98e8da68a57afedcc57c6b4733e5b20d34ba3423e73f0acb77567`. The history diff's matrix-multiply/Python `+294,437%` outlier is non-causal pending a repeated matched-environment run |
