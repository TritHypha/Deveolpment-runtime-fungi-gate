# Ubuntu Desktop platform evidence report - v2

Date: 2026-08-01
Operator: Codex with owner-provided host prerequisites
Evidence classification: CANDIDATE_NON_AUTHORIZING
Version: v2 supplemental editorial copy; no new execution or authority

Canonical evidence pair:

- `ubuntu-desktop-static-profile-2026-08-01-2ceaf47987da.md`
- `ubuntu-desktop-static-profile-2026-08-01-2ceaf47987da.receipt.json`
...
- Working tree after run: the canonical report and its paired raw receipt were the only evidence changes; Cargo build output was ignored and no source file changed
...
| Evidence | Status | Why |
|---|---|---|
| Linux host/filesystem gate | UNVERIFIED | Adapter chapter was not implemented at the tested commit |
| File + directory barriers | UNVERIFIED | Adapter chapter was not implemented at the tested commit |
| Process termination | UNVERIFIED | Recovery harness was not implemented at the tested commit |
...
This v2 file is a supplemental presentation of the same evidence. It does not
replace the canonical report/receipt naming contract and does not incorporate
the later Linux-adapter or SLIDE-observer handover chapter.
