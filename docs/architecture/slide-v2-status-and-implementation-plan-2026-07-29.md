...
| V2 executable GIR | `IMPLEMENTED-PARTIAL` | V2-A detached graph/runtime; non-authorizing V2-B capability/lease/nonce evidence reference; V2-C immutable aggregate logical model and validation | Canonically encode/import/digest/execute V2-C, then V2-D memory; integrate real V2-B receipt/broker adapters separately |
