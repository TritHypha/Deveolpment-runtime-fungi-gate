# Slices 373-397 WASM target and test harness conversion plan
...
**Goal:** Account nine WASM-target scopes and 16 consolidated test-harness
scopes without mistaking erased TypeScript, host process effects or filesystem
navigation for admitted Fungi/SLIDE authority.

**Architecture:** Split three independently reviewable dossiers: WASM record
validation/reporting, CLI/process control, and parsing/path resolution. Preserve
exact host observations and classify every absent physical type/effect as a
named blocker; create no placeholder Fungi.
...
- Pin HEAD `ce842d8e20c2139f7bfc65f212a635cac224e8f9` and each full source SHA-256.
...
| 373 | `WasmTarget` |
| 374 | `WasmArtefact` |
| 375 | `WasmTargetReport` |
| 376 | `WasmDiagnosticSeverity` |
| 377 | `WasmDiagnostic` |
| 378 | `WASM_RUNTIMES` |
| 379 | `wasmDiagnostic` |
| 380 | `validateWasmArtefact` |
| 381 | `createWasmTargetReport` |
| 382 | `KINDS` |
| 383 | `usage` |
| 384 | `fail` |
| 385 | `ParsedArgs` |
...
| 391 | `parseCounts` |
| 392 | nested `grab` |
| 393 | `parseAggregateTotal` |
| 394 | `WORKSPACE_MARKER` |
| 395 | `findUp` |
| 396 | `resolveRoot` |
| 397 | `resolveTarget` |

### Task 1: Pin source and focused evidence

- [x] Pin WASM source SHA-256
  `D6E1E90649E2378003565C2F710B483C9168B6B1324176462FF0A5424CC8095A`.
- [x] Pin CLI source SHA-256
  `855D7882F41EA7D870A99C7C3F81BA5655C74415A36646E6FC2B0F3A003C1158`.
- [x] Pin parse source SHA-256
