...
- [x] **Step 1: Preserve and classify the existing dirty guidance**
...
- [x] **Step 2: Write the failing history test**
...
- [x] **Step 4: Implement bounded history scanning**
...
- [x] **Step 5: Add automated verification**
...
- run: skills-ref validate "${{ github.workspace }}"
```

- [x] **Step 6: Prove GREEN and validate the skill**

Run the focused test, release audit, pinned `skills-ref` through `uvx --from git+https://github.com/agentskills/agentskills@69ef37e9424c0a7ea9dd2293b559e43ec8176379#subdirectory=skills-ref skills-ref validate <absolute-skill-root>`, local Codex `quick_validate.py`, and `git diff --check`. Expected: all exit `0`.

- [x] **Step 7: Commit the exact repository changes**
...
- [x] **Step 3: Verify public custody**
...
- [x] **Step 1: Write and prove the independent RED test**
...
- [x] **Step 2: Implement the independent bounded scanner**
...
- [x] **Step 3: Add the pinned workflow**
