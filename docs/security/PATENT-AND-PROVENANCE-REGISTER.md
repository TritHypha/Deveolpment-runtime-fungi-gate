...
| Galerina feature and source | private post-v1 `packages-ts/galerina-ai-neuromorphic/src/index.ts`; validators for spike/event records, scalar model counts and bounded non-executing plans |
