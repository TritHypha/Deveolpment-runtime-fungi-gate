...
const SELFTEST_VIA_TEST = {
  ...
  "audit-diagnostic-codes.mjs":    { test: "scripts/tests/audit-gate-evidence-group-2.test.mjs", proves: "hermetic diagnostic-name collision refusal plus one-to-one control" },
  "audit-kernel-floor.mjs":        { test: "scripts/tests/audit-gate-evidence-group-2.test.mjs", proves: "hermetic non-seam host primitive refusal plus confined-floor control" },
  "audit-scratchdir-hygiene.mjs":  { test: "scripts/tests/audit-gate-evidence-group-2.test.mjs", proves: "hermetic missing-cleanup refusal plus own-PID cleanup control" },
  "audit-selfhost-readiness.mjs":  { test: "scripts/tests/audit-gate-evidence-group-3.test.mjs", proves: "hermetic floor classification plus fully-Fungi report-only control" },
  "audit-signed-fixture-drift.mjs":{ test: "scripts/tests/audit-gate-evidence-group-3.test.mjs", proves: "hermetic tracked ceremony-signed clean-to-drift refusal" },
  "audit-stray-docs.mjs":          { test: "scripts/tests/audit-gate-evidence-group-3.test.mjs", proves: "hermetic stray-document discovery plus docs-contained report-only control" },
