...
export const MAX_DIFFERENTIAL_VECTORS = 25;
...
export const BLOCKERS = Object.freeze({
  ...
  BIGINT: "BLOCKED_BY_JAVASCRIPT_BIGINT_AND_SELECTED_PHYSICAL_INT_ABI",
  ...
  PHYSICAL_INT_RANGE: "BLOCKED_BY_SELECTED_PHYSICAL_INT_RANGE_ABI",
  PHYSICAL_FINITE_FLOAT_LITERAL: "BLOCKED_BY_SELECTED_PHYSICAL_FINITE_FLOAT_LITERAL_ABI",
  PHYSICAL_STRING_LITERAL: "BLOCKED_BY_SELECTED_PHYSICAL_STRING_LITERAL_ABI",
  PHYSICAL_STRING_PARAMETER: "BLOCKED_BY_SELECTED_PHYSICAL_STRING_PARAMETER_ABI",
  UNRESOLVED_OBSERVATION: "BLOCKED_BY_UNRESOLVED_IDENTIFIER_OR_PROPERTY_OBSERVATION_ABI",
  UNRESOLVED_EXPRESSION: "BLOCKED_BY_UNRESOLVED_EXPRESSION_SHORT_CIRCUIT_COERCION_AND_EFFECT_ABI",
...
export function canonicalSourceSymbol(value) {
  if (typeof value !== "string" || !/^[A-Za-z_$][A-Za-z0-9_$]*(?:\.[A-Za-z_$][A-Za-z0-9_$]*)?$/u.test(value)) {
    throw new SandboxRefusal("SOURCE_SYMBOL_INVALID", "source symbol must be one identifier or one qualified member");
  }
  return value;
}
