...
import {
  normaliseFloor,
} from "../../packages-galerina/galerina-core-compiler/dist/capability-types.js";
...
it(
  "publishes and independently re-admits floor normalization through SLIDE/VOK",
  ...
  async () => {
    ...
    const parent = await mkdtemp(join(tmpdir(), "galerina-floor-normalisation-slide-"));
    ...
    try {
      ...
      for (const value of VALUES) {
        ...
        assert.equal(verified.value, normaliseFloor(value), JSON.stringify(value));
