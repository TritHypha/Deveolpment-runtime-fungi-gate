...
const CANONICAL_SCRIPT = resolve("scripts/gen-roadmap.mjs");
const LEGACY_SCRIPT = resolve("scripts/gen-roadmap-subway.mjs");
const SCRIPT = existsSync(CANONICAL_SCRIPT) ? CANONICAL_SCRIPT : LEGACY_SCRIPT;
